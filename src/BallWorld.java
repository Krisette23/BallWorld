...
// bollen krymper eller växer
    ...
    public Ball( int x0, int y0, int dx0, int dy0, int bminDiameter, int bmaxDiameter) {
        x = x0;
        y = y0;
        dx = dx0;
        dy = dy0;
        minDiameter = bminDiameter;
        maxDiameter =bmaxDiameter;
        shrink = false;
    ...
    public void setBallDiameter(int newDiameter)
    {
...
class BallPanel extends JPanel implements ActionListener {
    ...
    public BallPanel (int width, int height) {
        ...
        // Skapa en ny boll
        ball = new Ball( width / 10, height / 5, 5, 5, 10, 40 );
        // bytt bollens färg till vit
        ball.setColor(Color.white);
        // Sätt bollens rektangulära begränsande område (bounding box)
        ball.setBoundingBox( new Rectangle( 0, 0, width, height ) );
        //sätt bollens diameter 30.
        ball.setBallDiameter(30);

        // Skapa en ny boll2 med andra egenskaper
         ball2 = new Ball(width / 5, height / 10, 10, 10, 15, 35);
        // Sätt bollens storlek och färg
        //bytt bollens diameter(storlek till 15)
        ball2.setBallDiameter(25);

        // bytt bollens färg till röd
...
// sätt bollen på en nytt färg.
        ...
        //rita ut den andra bollen (på svart bakgrund)
        ball2.paint( g );
    }
